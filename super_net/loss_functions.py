...
def make_chi2_training_data_test(
    make_data_values,
    make_pred_data
):
    """
    ...
    def chi2(pdf, batch_idx):
        ...
        TODO
        """
        diff = make_pred_data(pdf)[central_values_idx][batch_idx] - central_values[batch_idx]
...
mc_replicas_make_chi2_training_data_test = collect("make_chi2_training_data_test", ("trval_replica_indices",))


def make_chi2_validation_data_test(
    make_data_values,
    make_pred_data
):
    """
