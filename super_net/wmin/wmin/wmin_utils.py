...
def precomputed_predictions(make_pred_data_non_vectorized, weight_minimization_grid):
    """
    Precompute predictions for the basis of wmin using make_pred_data_non_vectorized.
    """

    # Precompute predictions for the basis of wmin
    predictions = jnp.array(
        [
            make_pred_data_non_vectorized(weight_minimization_grid.wmin_INPUT_GRID[i])
