...
def likelihood_float_type(_chi2, _pred_data, pdf_model, FIT_XGRID, bayesian_prior, output_path):
    """
    ...
    params = bayesian_prior(jax.random.uniform(jax.random.PRNGKey(9), shape=(len(pdf_model.param_names), )))
