...
from conftest import CLOSURE_TEST_PDFSET, PSEUDODATA_SEED, TRVAL_INDEX, REPLICA_INDEX, TEST_DATASETS
from colibri.api import API as colibriAPI

MC_PSEUDODATA = {"level_1_seed": PSEUDODATA_SEED, **CLOSURE_TEST_PDFSET, **TRVAL_INDEX, **REPLICA_INDEX, **TEST_DATASETS}
...
def test_mc_pseudodata():
    ...
    """
    reference_pseudodata = pd.read_csv(TEST_COMMONDATA_FOLDER / "NMC_level2_central_values.csv")
