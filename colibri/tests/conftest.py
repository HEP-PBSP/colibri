...
MOCK_CENTRAL_SQRT_COVMAT_INDEX = Mock()
MOCK_CENTRAL_SQRT_COVMAT_INDEX.central_values = jnp.ones(TEST_N_DATA)
MOCK_CENTRAL_SQRT_COVMAT_INDEX.sqrt_covmat = jnp.eye(TEST_N_DATA)
MOCK_CENTRAL_SQRT_COVMAT_INDEX.central_values_idx = jnp.arange(TEST_N_DATA)
"""
Mock instance of Central sqrt covmat index object.
"""
